export function createCaseStudyPanel(): HTMLElement {
  ...
  panel.innerHTML = `
    ...
    <p>Strict TypeScript, 57 deterministic logic and contract tests, an import boundary that keeps engines framework-free, and Playwright suites that read canvas pixels to prove the selected game is truly on screen — across desktop and mobile viewports.</p>
  `;
  return panel;
}
